...
**Так называемый "Киберпортал" в TG украл исходный код и продает его за 
деньги, назвав приложение PortalConnect!**
**Бесплатный и свободный оригинал приложения ТОЛЬКО здесь!**
...
*   **Доступный исходный код и модификации:** Код приложения открыт. Вы можете изменять его, дорабатывать или создавать свои версии, **при соблюдении следующих жестких условий**:
    * Вы обязаны сохранить четкое указание авторства **SLY-F0X**, а также авторов интегрированных компонентов: **Snawoot** (opera-proxy) и проекта **Tun2Proxy**.
    * Любые модифицированные версии должны распространяться на тех же некоммерческих условиях.
