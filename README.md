...
Будьте бдительны: подобные «клоны» могут содержать скрытые угрозы и создаются исключительно с целью монетизации и паразиторования на чужом труде. 

**Оригинальное приложение распространяется бесплатно и только на данном ресурсе.** Приложение не представлено на других площадках или в сторонних группах.
---
