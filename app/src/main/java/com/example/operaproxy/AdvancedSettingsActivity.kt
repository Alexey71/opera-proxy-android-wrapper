...
class AdvancedSettingsActivity : AppCompatActivity() {
    ...
    private val DEFAULT_BOOTSTRAP =
        "https://1.1.1.3/dns-query,https://8.8.4.4/dns-query,tls://9.9.9.9:853,https://security.cloudflare-dns.com/dns-query,https://wikimedia-dns.org/dns-query,https://dns.adguard-dns.com/dns-query,https://dns.quad9.net/dns-query,https://dns.comss.one/dns-query,https://router.comss.one/dns-query"
    private val DEFAULT_TEST_URL =
        "https://translate.yandex.ru/icons/favicon.ico"
